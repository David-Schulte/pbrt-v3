...
// ------------------------------------------------------------------------------------
    ...
    template <typename T, long NR, long NCDLIB, typename MM, typename L, typename EXP>
    inline void add_to (
...
// ------------------------------------------------------------------------------------
    ...
    template <typename T, long NR, long NCDLIB, typename MM, typename L, typename EXP, typename U>
    inline void add_to (
        matrix<T,NR,NCDLIB,MM,L>& dest,
        const matrix_exp<EXP>& src,
        const U& C
...
// ----------------------------------------------------------------------------------------
    ...
    template <typename EXP, typename T, long NR, long NCDLIB, typename MM, typename L>
    void sparse_matrix_vector_multiply (
        const std::vector<sample_pair>& edges,
        const matrix_exp<EXP>& v,
        matrix<T,NR,NCDLIB,MM,L>& result
    )
    {
        // make sure requires clause is not broken
