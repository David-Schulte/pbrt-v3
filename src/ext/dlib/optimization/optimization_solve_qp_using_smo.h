...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        ...
        matrix<T,NR,NCDLIB,MM,L> df = Q*alpha - b;
...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        ...
        */
        ...
        matrix<T,NR,NCDLIB,MM,L> df = Q*alpha - b - trans(A)*lambda;
...
// ----------------------------------------------------------------------------------------
    ...
    unsigned long solve_qp_box_constrained ( 
        ...
        matrix<T,NR,NCDLIB,MM,L>& alpha,
        const matrix<T,NR,NCDLIB,MM,L>& lower,
        const matrix<T,NR,NCDLIB,MM,L>& upper,
        T eps,
        unsigned long max_iter
    )
    {
        ...
        // Compute f'(alpha) (i.e. the gradient of f(alpha)) for the current alpha.  
        matrix<T,NR,NCDLIB,MM,L> df = Q*alpha + b;
        matrix<T,NR,NCDLIB,MM,L> QQ = reciprocal_max(diag(Q));
        ...
        matrix<T,NR,NCDLIB,MM,L> v, v_old; 
        v = alpha;
