...
// ----------------------------------------------------------------------------------------
    ...
    struct op_subm_range 
    {
        ...
        const static long NR = M2::NCDLIB*M2::NR;
        const static long NCDLIB = M3::NCDLIB*M3::NR;
...
// ----------------------------------------------------------------------------------------
    ...
    struct op_colm_range 
    {
        ...
        const static long NCDLIB = M2::NCDLIB*M2::NR;
        const static long cost = M1::cost+M2::cost;
...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        typedef matrix<T,NR,NCDLIB,mm,l> matrix_type;

        assignable_sub_matrix(
            matrix<T,NR,NCDLIB,mm,l>& m_,
            long top_,
            long left_,
            long height_,
            long width_
    ...
    template <typename T, long NR, long NCDLIB, typename mm, typename l>
    assignable_sub_matrix<T,NR,NCDLIB,mm,l> set_subm (
        matrix<T,NR,NCDLIB,mm,l>& m,
        const rectangle& rect
    )
    {
        ...
        return assignable_sub_matrix<T,NR,NCDLIB,mm,l>(m,rect.top(), rect.left(), rect.height(), rect.width());
    }
    ...
    )
    {
        ...
        return assignable_sub_matrix<T,NR,NCDLIB,mm,l>(m,r,c, nr, nc);
    }

// ----------------------------------------------------------------------------------------

    template <typename T, long NR, long NCDLIB, typename mm, typename l, typename EXPr, typename EXPc>
    ...
    template <typename T, long NR, long NCDLIB, typename mm, typename l, typename EXPr, typename EXPc>
    assignable_sub_range_matrix<T,NR,NCDLIB,mm,l,EXPr,EXPc > set_subm (
        matrix<T,NR,NCDLIB,mm,l>& m,
        const matrix_exp<EXPr>& rows,
        const matrix_exp<EXPc>& cols
    )
    {
        ...
        return assignable_sub_range_matrix<T,NR,NCDLIB,mm,l,EXPr,EXPc >(m,rows.ref(),cols.ref());
    }

// ----------------------------------------------------------------------------------------

    template <typename T, long NR, long NCDLIB, typename mm, typename l, typename EXPr>
    assignable_sub_range_matrix<T,NR,NCDLIB,mm,l,EXPr,matrix_range_exp<long> > set_rowm (
        matrix<T,NR,NCDLIB,mm,l>& m,
        const matrix_exp<EXPr>& rows
    )
    {
        ...
        return assignable_sub_range_matrix<T,NR,NCDLIB,mm,l,EXPr,matrix_range_exp<long> >(m,rows.ref(),range(0,m.nc()-1));
    }

// ----------------------------------------------------------------------------------------

    template <typename T, long NR, long NCDLIB, typename mm, typename l, typename EXPc>
    assignable_sub_range_matrix<T,NR,NCDLIB,mm,l,matrix_range_exp<long>,EXPc > set_colm (
        matrix<T,NR,NCDLIB,mm,l>& m,
        const matrix_exp<EXPc>& cols
    )
    {
        ...
        return assignable_sub_range_matrix<T,NR,NCDLIB,mm,l,matrix_range_exp<long>,EXPc >(m,range(0,m.nr()-1),cols.ref());
    }
...
// ----------------------------------------------------------------------------------------
    ...
    template <typename T, long NR, long NCDLIB, typename mm, typename l>
    assignable_col_matrix<T,NR,NCDLIB,mm,l> set_colm (
        matrix<T,NR,NCDLIB,mm,l>& m,
        const long col 
    )
    {
        ...
        return assignable_col_matrix<T,NR,NCDLIB,mm,l>(m,col);
    }
...
// ----------------------------------------------------------------------------------------
    ...
    template <typename T, long NR, long NCDLIB, typename mm, typename l>
    assignable_row_matrix<T,NR,NCDLIB,mm,l> set_rowm (
        matrix<T,NR,NCDLIB,mm,l>& m,
        const long row 
    )
    {
        ...
        return assignable_row_matrix<T,NR,NCDLIB,mm,l>(m,row);
    }
