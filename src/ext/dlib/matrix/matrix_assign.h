...
// ----------------------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------------------------------
        ...
        struct matrix_type_id<matrix<T,NR,NCDLIB,MM,L> >
        {
        ...
        template <typename T, long NCDLIB, typename MM, typename L>
        struct matrix_type_id<matrix<T,1,NCDLIB,MM,L> >
        {
    ...
    // ------------------------------------------------------------------------------------
        ...
        template <typename T, long NR, long NCDLIB, typename MM, typename L>
        struct matrix_type_id<matrix_op<op_colm<matrix<T,NR,NCDLIB,MM,L> > > >
        {
            const static int value = column_matrix;
        };

        template <typename T, long NR, long NCDLIB, typename MM, typename L>
        struct matrix_type_id<matrix_op<op_rowm<matrix<T,NR,NCDLIB,MM,L> > > >
        {
            const static int value = row_matrix;
        };

        template <typename T, long NR, long NCDLIB, typename MM, typename L>
        struct matrix_type_id<matrix_op<op_colm2<matrix<T,NR,NCDLIB,MM,L> > > >
        {
            const static int value = column_matrix;
        };

        template <typename T, long NR, long NCDLIB, typename MM, typename L>
        struct matrix_type_id<matrix_op<op_rowm2<matrix<T,NR,NCDLIB,MM,L> > > >
        {
            const static int value = row_matrix;
        };

        template <typename T, long NR, long NCDLIB, typename MM, typename L>
        struct matrix_type_id<matrix_op<op_subm<matrix<T,NR,NCDLIB,MM,L> > > >
        {
            const static int value = general_matrix;
        };
...
#define DLIB_END_BLAS_BINDING }};
    ...
    // ------------------------------------------------------------------------------------
        ...
        template <
            typename T, long NR, long NCDLIB, typename MM, typename L,
            typename src_exp 
            >
        void matrix_assign_blas (
            matrix<T,NR,NCDLIB,MM,L>& dest,
            const src_exp& src
        );
        ...
        void matrix_assign_blas (
            matrix<T,NR,NCDLIB,MM,L>& dest,
            const matrix_add_exp<matrix<T,NR,NCDLIB,MM,L> ,src_exp>& src
        );
        /*!
        ...
        void matrix_assign_blas (
            matrix<T,NR,NCDLIB,MM,L>& dest,
            const matrix_add_exp<src_exp, matrix<T,NR,NCDLIB,MM,L> >& src
        );
        /*!
            This function catches the expressions of the form:  
                M = exp + M; 
        ...
        void matrix_assign_blas (
            matrix<T,NR,NCDLIB,MM,L>& dest,
            const matrix_subtract_exp<matrix<T,NR,NCDLIB,MM,L> ,src_exp>& src
        );
        /*!
            This function catches the expressions of the form:  
                M = M - exp; 
    ...
    // ------------------------------------------------------------------------------------
        ...
        )
        {
            if (src.aliases(dest))
            {
                matrix<T,NR,NCDLIB,MM,L> temp(dest.nr(),dest.nc());
    ...
    // ------------------------------------------------------------------------------------
        ...
        template <
            ...
            >
        void matrix_assign_blas (
            assignable_sub_matrix<T,NR,NCDLIB,MM,L>& dest,
            const src_exp& src
        )
        {
    ...
    // ------------------------------------------------------------------------------------
        ...
        template <
            ...
            >
        void matrix_assign_blas (
            assignable_row_matrix<T,NR,NCDLIB,MM,L>& dest,
            const src_exp& src
        )
        {
            if (src.aliases(dest.m))
    ...
    // ------------------------------------------------------------------------------------
        ...
        template <
            ...
            >
        void matrix_assign_blas (
            assignable_col_matrix<T,NR,NCDLIB,MM,L>& dest,
            const src_exp& src
        )
        {
            if (src.aliases(dest.m))
    ...
    // ------------------------------------------------------------------------------------
        ...
        )
        {
            ...
            {
                matrix<T,NR,NCDLIB,MM,L> temp(src.lhs);
    ...
    // ------------------------------------------------------------------------------------
        ...
        )
        {
            ...
            typedef matrix_add_exp<matrix<T,NR,NCDLIB,MM,L> ,src_exp> swapped_add_exp;
