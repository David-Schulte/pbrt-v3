...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        const static long NCDLIB = matrix_traits<matrix_range_exp>::NCDLIB;
...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        const static long NCDLIB = matrix_traits<matrix_log_range_exp>::NCDLIB;
...
// ----------------------------------------------------------------------------------------
    ...
    struct matrix_traits<matrix_range_static_exp<start,inc_,end> >
    {
        ...
        typedef default_memory_manager mem_manager_type;
        const static long NR = 1;
        const static long NCDLIB = tabs<(end - start)>::value/inc_ + 1;
        const static long cost = 1;
        typedef row_major_layout layout_type;
    };
    ...
    public:
        ...
        const static long NCDLIB = matrix_traits<matrix_range_static_exp>::NCDLIB;
